...
$db['pkaccount']['hostname'] = '23.229.215.154';
$db['pkaccount']['username'] = 'pkaccount';
$db['pkaccount']['password'] = 'Pr4y2ct4';

$db['pkaccount']['database'] = 'pkaccount';
